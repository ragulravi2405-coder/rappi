...
class AppTheme {
  ...
  static const Color bgDark = Color(0xFF1A1D24); // Soft modern slate navy (not pitch black)
  static const Color bgLight = Color(0xFFF8F9FA); // Soft clean white-grey
  
  static const Color cardDark = Color(0xFF252833); // Soft slate card
